...
```{r}
mean(exp_2_selection_data $age)
sd(exp_2_selection_data $age)
min(exp_2_selection_data $age)
max(exp_2_selection_data $age)
```
...
# make machine a factor and relable such that "separate_parts " becomes "scrambled" 
